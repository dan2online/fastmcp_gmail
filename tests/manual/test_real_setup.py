...
def main():
    ...
    checks = [
        ("File Structure", lambda: (
            check_file_exists("core/gmail_client.py", "Gmail client") and
            check_file_exists("core/gmail_reader.py", "Gmail reader") and
            check_file_exists("docs/GMAIL_SETUP.md", "Setup guide") and
