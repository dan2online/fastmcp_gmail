...
class TestGmailReaderIntegration(unittest.TestCase):
    ...
    def test_gmail_reader_with_cache_integration(self):
        ...
        self.mock_service.users().messages().get().execute.return_value = mock_email_data
    ...
    def test_concurrent_cache_access(self):
        ...
        from core.email_summarizer import save_cache as save_email_cache, load_cache as load_email_cache
