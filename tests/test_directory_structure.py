...
class TestDirectoryStructure(unittest.TestCase):
    ...
    def test_cache_directory_structure(self):
        ...
        self.assertTrue(str(EMAIL_CACHE_FILE).endswith("cache/email_summary_cache.json"))
    ...
    def test_directory_creation(self):
        ...
        from core.email_summarizer import CACHE_FILE as EMAIL_CACHE_FILE, save_cache as save_email_cache
    ...
    def test_no_root_directory_pollution(self):
        ...
        from core.email_summarizer import load_cache as load_email_cache, save_cache as save_email_cache
        ...
        root_files = list(self.test_dir.glob("*.json")) + list(self.test_dir.glob("*.log")) + list(self.test_dir.glob("*.md"))
        cache_log_files = [f for f in root_files if f.name in [
            "llm_cache.json", "email_summary_cache.json", "llm_log.md", 
            "fastmcp_server.log", "mcp_server.log"
        ]]
        
        self.assertEqual(len(cache_log_files), 0, 
