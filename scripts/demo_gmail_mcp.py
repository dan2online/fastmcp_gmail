    ...
    try:
        ...
        for i, email_data in enumerate(emails, 1):
            ...
            if content_text:
                ...
                print(f"   💬 Preview: {preview}{'...' if len(content_text) > 150 else ''}")
            
            # Generate AI response for unread emails
            if email_data['metadata']['is_unread'] and i <= 3:  # Limit to first 3 unread
        ...
        for query in queries:
            ...
            for email_data in results:
                ...
                if email_data['attachments']:
                    print(f"      📎 Attachments: {[att['filename'] for att in email_data['attachments']]}")
